...
import com.hnweb.punnyfuzzleiap.punnyfuzzle.singleplayer.SinglePlayerCreditListActivity;
...
public class SinglePalyerScoreActivity extends AppCompatActivity {
    String TAG = SinglePalyerScoreActivity.class.getSimpleName();
...
//            }
    ...
    public void btnBack_onClick(View view) {
        try {
            SinglePalyerScoreActivity.this.onBackPressed();
        } catch (Exception ex) {
