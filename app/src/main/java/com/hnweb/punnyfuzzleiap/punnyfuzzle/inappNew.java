...
public class inappNew extends Activity implements IabBroadcastReceiver.IabBroadcastListener,
    ...
    static final String SKU_PLAN1 = "40puzzle";
    static final String SKU_PLAN2 = "100puzzle";
    ...
    IabHelper.QueryInventoryFinishedListener mGotInventoryListener = new IabHelper.QueryInventoryFinishedListener() {
        public void onQueryInventoryFinished(IabResult result, Inventory inventory) {
           ...
           /* if (plan.equalsIgnoreCase("1")) {
                ...
                if (inventory.hasPurchase(SKU_PLAN2)) {

                    try {
                        mHelper.consumeAsync(inventory.getPurchase(SKU_PLAN2), null);
                    } catch (IabHelper.IabAsyncInProgressException e) {
                        e.printStackTrace();
                    }
                }
    ...
    IabHelper.OnIabPurchaseFinishedListener mPurchaseFinishedListener = new IabHelper.OnIabPurchaseFinishedListener() {
        public void onIabPurchaseFinished(IabResult result, Purchase purchase) {
            ...
            if (purchase.getSku().equals(SKU_PLAN1)) {
                ...
                Utilities.showAlertDailog(inappNew.this, "PunnyFuzzle", "Payment Successfully Done.", "Ok",
            ...
            } else if (purchase.getSku().equals(SKU_PLAN2)) {
                Utilities.showAlertDailog(inappNew.this, "PunnyFuzzle", "Payment Successfully Done.", "Ok",
                        new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface arg0, int arg1) {
